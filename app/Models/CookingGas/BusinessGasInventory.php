...
class BusinessGasInventory extends Model
{
    /**
     ...
     * Table name
     */
    protected $table = 'business_gas_inventory';
    ...
    {
        $image = GasQntImage::where('gas_cylinder_id', $this->gas_cylinder_id)
