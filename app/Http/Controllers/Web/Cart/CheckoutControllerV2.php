...
class CheckoutControllerV2 extends Controller
{
    ...
    public function checkoutInvoice(Request $request)
    {
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | First Receiving Business
        |--------------------------------------------------------------------------
        */

        $firstBusinessData = collect($checkout['shipment'])->first();
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Create Invoice + Checkout Items
        |--------------------------------------------------------------------------
        */

        $invoice = DB::connection('customer')->transaction(function () use (
            $request,
            $customer,
            $paymentData,
            $invoiceData,
            ...
            $invoice = CheckoutInvoice::create([
                ...
                */
                ...
                'alternative_phone_number' => $request->alt_phone,
                ...
                */
                ...
                'delivery_location' => $request->county . ', ' . $request->town,
