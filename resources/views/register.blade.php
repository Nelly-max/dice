                ...
                <!-- ADD THIS ERROR VISIBILITY BLOCK HERE -->
                    ...
                    <form action="{{ route('account.register.create') }}" method="POST">
                        ...
                        <div class="input-radio">
                            <span><input type="radio" name="gender" value="male" {{ old('gender') === 'male' ? 'checked' : '' }}> Male</span>
                            <span><input type="radio" name="gender" value="female" {{ old('gender') === 'female' ? 'checked' : '' }}> Female</span>
                        </div>
