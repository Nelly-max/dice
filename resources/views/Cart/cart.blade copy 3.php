                ...
                <div class="cart-items">
                    ...
                    @foreach($shipment['items'] as $item)
                        ...
                        <form method="POST"
                            ...
                            <div class="cart-item"
                                        data-subdivision-id="{{ $shipment['subdivision_id'] }}"
     data-db-connection="{{ $shipment['db_connection'] }}"
     data-biz-name="{{ $shipment['business_name'] }}"
     data-biz-lat="{{ $shipment['latitude'] }}" 
     data-biz-lng="{{ $shipment['longitude'] }}">
                    ...
                    <div class="sub-total">
                        ...
                        <button type="button" class="btn-proceed-checkout" data-checkout-url="{{ route('cart.checkout') }}">
                            Checkout
                        </button>
